...
class Region extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('dealer_region', 'region_id');
    }
     ...
     * @return \Cleargo\DealerNetwork\Model\ResourceModel\Region
     */
    protected function _beforeDelete(\Magento\Framework\Model\AbstractModel $object)
    {
        $condition = ['region_id = ?' => (int)$object->getId()];

        $this->getConnection()->delete($this->getTable('dealer_region_store'), $condition);
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $table = $this->getTable('dealer_region_store');
     ...
     * @param string $field
     * @param mixed $value
     * @param \Cleargo\DealerNetwork\Model\Region $object
    ...
    protected function _getLoadSelect($field, $value, $object)
    {
        ...
        if ($object->getStoreId()) {
            ...
            $select->join(
                ['cbs' => $this->getTable('dealer_region_store')],
    ...
    public function lookupStoreIds($id)
    {
        ...
        $select = $connection->select()->from(
            $this->getTable('dealer_region_store'),
            'store_id'
        )->where(
            'region_id = :region_id'
        );
