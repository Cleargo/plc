...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Cleargo_DealerNetwork::dealer_country')
            ->addBreadcrumb(__('Dealer Network'), __('Dealer Network'))
            ->addBreadcrumb(__('Manage Countries'), __('Manage Countries'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        if ($id) {
            $model->load($id);
            if (!$model->getId()) {
                $this->messageManager->addError(__('This country no longer exists.'));
        ...
        $this->_coreRegistry->register('dealer_country', $model);
        ...
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getName() : __('New Country'));
