...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Cleargo_DealerNetwork::region_save');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Cleargo_DealerNetwork::dealer_region')
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Cleargo\DealerNetwork\Model\Region');
        ...
        $this->_coreRegistry->register('dealer_region', $model);
