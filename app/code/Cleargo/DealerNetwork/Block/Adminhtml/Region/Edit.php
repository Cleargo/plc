 ...
 */
namespace Cleargo\DealerNetwork\Block\Adminhtml\Region;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        if ($this->_coreRegistry->registry('dealer_region')->getId()) {
            return __("Edit Region '%1'", $this->escapeHtml($this->_coreRegistry->registry('dealer_region')->getTitle()));
        } else {
