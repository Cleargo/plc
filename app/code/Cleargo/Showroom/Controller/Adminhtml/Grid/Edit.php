...
{ 
    ...
    /**
     * @var \Cleargo\Showroom\Model\Grid
     */
    protected $_model;
     ...
     * @param \Cleargo\Showroom\Model\Grid $model
     */
    public function __construct(
        Action\Context $context,
        \Magento\Framework\View\Result\PageFactory $resultPageFactory,
        \Magento\Framework\Registry $registry,
        \Cleargo\Showroom\Model\Grid $model
    ) {
    ...
    {
        return $this->_authorization->isAllowed('Cleargo_Showroom::grid_save');
    }
    ...
    protected function _initAction()
    {
        ...
        /*$resultPage->setActiveMenu('Cleargo_Showroom::grid')
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('showroom_grid', $model);
