...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
       ...
       /* $resultPage->setActiveMenu('Cleargo_Warranty::warranty_warranty')
            ->addBreadcrumb(__('Warranty'), __('Warranty'))
            ->addBreadcrumb(__('Manage Warrantys'), __('Manage Warrantys'));*/
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('warranty_warranty', $model);
        ...
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getName() : __('New Warranty'));
