...
use Cleargo\Warranty\Model\WarrantyRepository;
...
class View extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_template = 'warranty/view.phtml';
    ...
    public function __construct(
        ...
        \Cleargo\Warranty\Model\WarrantyRepository $_warrantyRepository,
        ...
        $this->_warrantyRepository = $_warrantyRepository;
    ...
    public function getInputedValue() {
        ...
        if($id){
            $warranty = $this->_warrantyRepository->getById($id);
        }
