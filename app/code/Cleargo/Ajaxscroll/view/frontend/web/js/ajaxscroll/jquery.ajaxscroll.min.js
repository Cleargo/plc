				...
				if(typeof EM != 'undefined'){
                    ...
                    jQuery(function() {
						...
						function _qsJnit(){
							...
							var listprod = jQuery(selectorObj.itemClass);
							var qsImg;
                            ...
                            jQuery(document.body).append(_qsHref);
							
							var qsHandlerImg = jQuery('#md_quickview_handler img');

							sh.each(listprod, function(index, value) { 
								var reloadurl = baseUrl;
								
								//get reload url
								myhref = jQuery(value).children(selectorObj.aClass );
                                ...
                                jQuery(selectorObj.imgClass, this).bind('mouseover', function() {
									var o = jQuery(this).offset();
                                    jQuery('#md_quickview_handler').attr('href',reloadurl).show()
										.css({
											'top': o.top+(jQuery(this).height() - qsHandlerImg.height())/2+'px',
											'left': o.left+(jQuery(this).width() - qsHandlerImg.width())/2+'px',
											'visibility': 'visible'
										});
								});
                                jQuery(value).bind('mouseout', function() {
                                    jQuery('#md_quickview_handler').hide();
								});
							});

							//fix bug image disapper when hover
                            jQuery('#md_quickview_handler')
							...
							jQuery('#md_quickview_handler').fancybox({
									'titleShow'			: false,
