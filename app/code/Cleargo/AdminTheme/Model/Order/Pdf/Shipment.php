...
use Magento\Sales\Model\Order\Pdf\Shipment as OriginalShipment;



class Shipment extends OriginalShipment{
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        if ($order->getIsVirtual()) {
            ...
            if (count($tracks)) {
                ...
                $page->drawText(__('Carrier'), 290, $yShipments - 7, 'UTF-8');
                $page->drawText(__('Tracking Number'), 410, $yShipments - 7, 'UTF-8');
