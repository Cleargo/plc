...
use Cleargo\FindYourLock\Api\RegionRepositoryInterface;
...
use Cleargo\FindYourLock\Model\ResourceModel\Region as ResourceRegion;
use Cleargo\FindYourLock\Model\ResourceModel\Region\CollectionFactory as RegionCollectionFactory;
...
class RegionRepository implements RegionRepositoryInterface
{
    ...
    /**
     * @var \Cleargo\FindYourLock\Api\Data\RegionInterfaceFactory
     */
    ...
    public function getById($regionId)
    {
        ...
        if (!$region->getId()) {
            throw new NoSuchEntityException(__('District Region with id "%1" does not exist.', $regionId));
        }
        return $region;
    }
     ...
     * @return \Cleargo\FindYourLock\Model\ResourceModel\Region\Collection
     */
